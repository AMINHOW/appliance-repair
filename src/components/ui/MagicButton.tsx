...
function MagicButton({ button, border, content, title }: { button?: string, border?: string, content?: string, title: string }) {
  return (
    <button className={cn(`relative inline-flex h-8 overflow-hidden rounded-full p-[1px] hover:scale-110 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-slate-50 `, button)}>
